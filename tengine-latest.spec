...
NAME=tengine-latest
EPOCH=1
VERSION=$(git ls-remote --tags https://github.com/alibaba/tengine.git | perl -lne 'm[refs/tags/([\d.]+)$]sm ? print $1 : next' | sort -V | tail -n 1)
REVISION=1
ARCHITECTURE=source
...
function build() {
    ...
    curl -fsSL https://github.com/alibaba/tengine/archive/refs/tags/$VERSION.tar.gz | tar --strip-components=1 -xz
