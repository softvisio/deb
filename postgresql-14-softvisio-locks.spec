...
EPOCH=1
VERSION=$(git ls-remote --tags git://github.com/softvisio/postgresql-softvisio-locks.git | perl -lne 'm[refs/tags/v([\d.]+)$]sm ? print $1 : next' | sort -V | tail -n 1)
REVISION=1
ARCHITECTURE=source
DESCRIPTION="PostgreSQL backend locks"
